...
expensesRouter.post('/', authentication_1.authentication, (0, validation_1.validation)(expensesValidation.createExpenseSchema), expenses_service_1.default.addExpenses);
...
expensesRouter.put('/:id', authentication_1.authentication, (0, validation_1.validation)(expensesValidation.updateExpenseSchema), expenses_service_1.default.updateExpense);
expensesRouter.delete('/:id', authentication_1.authentication, (0, validation_1.validation)(expensesValidation.getExpenseByIdSchema), expenses_service_1.default.deleteExpense);
