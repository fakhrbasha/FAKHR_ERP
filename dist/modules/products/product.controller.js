...
productRouter.post('/add-product', (0, multer_1.multer_host)({ custom_type: multer_enum_1.imageTypes }).single("image"), authentication_1.authentication, (0, validation_1.validation)(productValidation.createProductSchema), product_service_1.default.addProduct);
productRouter.get('/', authentication_1.authentication, product_service_1.default.getProducts);
productRouter.put('/edit-product/:id', (0, multer_1.multer_host)({ custom_type: multer_enum_1.imageTypes }).single("image"), authentication_1.authentication, (0, validation_1.validation)(productValidation.editProductSchema), product_service_1.default.updateProduct);
